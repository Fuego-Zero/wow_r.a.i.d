...
import { recreateRecord } from "../api";
...
function RecreateSignupRecord(props: Props) {
  ...
  function openRecreateSignupRecord() {
  ...
  return (
    <>
      <Button block type="default" onClick={openRecreateSignupRecord}>
        重新报名
      </Button>
      <Modal
        open={isOpen}
...
export default RecreateSignupRecord;
